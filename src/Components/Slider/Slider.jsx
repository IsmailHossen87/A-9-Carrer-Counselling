    ...
    <div className="my-5">
      <div className="carousel w-full object-cover">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          <img
            src={frist}
            className="w-full h-[500px] rounded-xl object-cover" // Fixed height of 500px
          />
          <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between items-center">
            ...
            <div>
              <h2 className="lg:text-6xl md:text-4xl text-2xl font-bold text-center text-white w-[90%] md:w-[80%] mx-auto">
